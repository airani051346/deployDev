...
INSERT INTO discovered VALUES(1,'192.168.178.172','gw-2570-01',4,'{"win": "xxx", "Router_ip": "10.1.1.1", "LAN1_ip": "172.168.99.1", "LAN1_subnetmask": "255.255.255.0", "Megamon_ip": "10.0.0.1", "LAN2_subnetmask": "255.255.255.128", "hostname": "gw-2570-01"}','claimed','embedded',6,2);
INSERT INTO discovered VALUES(2,'192.168.178.173','ybdfg',3,'{"Router_ip": "10.1.1.1", "LAN1_ip": "172.168.99.1", "LAN1_subnetmask": "255.255.255.0", "Megamon_ip": "10.0.0.1", "LAN2_subnetmask": "255.255.255.128", "hostname": "ybdfg"}','discovered','embedded',6,2);
CREATE TABLE scans (
...
CREATE TABLE HWType (id INTEGER PRIMARY KEY, Type TEXT);
...
INSERT INTO workers VALUES(1,1,'',replace('set hostname gw-2570-01\n\nenter_expert_mode:\nls -al\nexit_expert_mode:\nshow diag\nshow interfaces table','\n',char(10)),0,NULL,0);
